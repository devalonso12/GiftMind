...
interface GiftFlowState {
  currentStep: 'connect' | 'search' | 'profile' | 'recommend' | 'approve' | 'send' | 'complete';
  senderWallet: { address: string; balance: number; connected: boolean } | null;
  // Combined search: multiple social handles + wallet address
