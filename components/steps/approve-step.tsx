      ...
      <div className="surface-stellar-strong rounded-2xl p-6 space-y-5">
        <div className="flex items-center justify-between p-4 rounded-xl surface-void">
          <div>
            ...
            {recipientWallet && <p className="text-[10px] font-mono text-slate-600 mt-0.5">{recipientWallet.slice(0, 8)}...{recipientWallet.slice(-6)}</p>}
          </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <Label className="text-xs font-semibold uppercase tracking-wider text-slate-500">Gift Amount</Label>
          ...
          {editingAmount ? (
            ...
            <div className="relative p-5 rounded-xl overflow-hidden depth-4d">
              ...
              <div className="relative">
                <p className="text-3xl font-black text-solar">{amount.toFixed(4)} SOL</p>
